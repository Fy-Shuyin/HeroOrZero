...
/////// Vectors:
                ...
                float2 node_6902 = (i.uv0+node_2929.g*float2(0,-0.2));
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_6902, _node_3522));
                clip(((_node_3522_var.r*_rongjie)-_node_8317) - 0.5);
////// Lighting:
////// Emissive:
                float2 node_4096 = ((i.uv0+node_2929.g*float2(0.1,-0.2))+(i.uv0+node_2929.g*float2(0.1,-0.2)));
                float4 _node_7420_var = tex2D(_node_7420,TRANSFORM_TEX(node_4096, _node_7420));
                float2 node_2626 = ((i.uv0+node_2929.g*float2(0,-0.3))+(_node_7420_var.r*_node_2624));
                float4 _node_3919_var = tex2D(_node_3919,TRANSFORM_TEX(node_2626, _node_3919));
                float3 emissive = ((_node_3919_var.rgb*_lingdu)*_node_893.rgb);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
/////// Vectors:
                float4 node_4565 = _Time + _TimeEditor;
                float2 node_6902 = (i.uv0+node_4565.g*float2(0,-0.2));
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_6902, _node_3522));
                clip(((_node_3522_var.r*_rongjie)-_node_8317) - 0.5);
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
/////// Vectors:
                float4 node_4821 = _Time + _TimeEditor;
                float2 node_6902 = (i.uv0+node_4821.g*float2(0,-0.2));
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_6902, _node_3522));
                clip(((_node_3522_var.r*_rongjie)-_node_8317) - 0.5);
