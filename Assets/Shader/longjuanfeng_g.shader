...
/////// Vectors:
                float4 node_2563 = _Time + _TimeEditor;
                float2 node_3169 = ((i.uv0+node_2563.g*float2(0,-0.6))*_UV);
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_3169, _node_3522));
                clip(pow((i.vertexColor.a*((_node_893.a*(_node_3522_var.r*_rongjie))-_)),_power) - 0.5);
////// Lighting:
////// Emissive:
                float2 node_4096 = ((i.uv0+node_2563.g*float2(0.1,-0.3))+(i.uv0+node_2563.g*float2(0.1,-0.5)));
                float4 _node_7420_var = tex2D(_node_7420,TRANSFORM_TEX(node_4096, _node_7420));
                float2 node_2626 = ((i.uv0+node_2563.g*float2(0,0.3))+(_node_7420_var.r*_node_2624));
...
/////// Vectors:
                ...
                float2 node_3169 = ((i.uv0+node_5090.g*float2(0,-0.6))*_UV);
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_3169, _node_3522));
                clip(pow((i.vertexColor.a*((_node_893.a*(_node_3522_var.r*_rongjie))-_)),_power) - 0.5);
...
/////// Vectors:
                ...
                float2 node_3169 = ((i.uv0+node_9256.g*float2(0,-0.6))*_UV);
                float4 _node_3522_var = tex2D(_node_3522,TRANSFORM_TEX(node_3169, _node_3522));
                clip(pow((i.vertexColor.a*((_node_893.a*(_node_3522_var.r*_rongjie))-_)),_power) - 0.5);
